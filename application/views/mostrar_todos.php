...
?>
        <div class="col-md-6 col-sm-9 hero-feature">
            <img src="http://localhost:8080/stanleetribute/images/<?=$fila->Imagen?>" width="50%">
            <div class="caption">
                ...
                <?php if($user_id==0){
					...
					?><a href="<?=base_url()?>index.php/pages/add_cart/<?=$user_id?>/<?=$fila->Id?>" class="btn btn-success">Comprar</a>
				<?php } ?> 
                <a href="<?=base_url()?>index.php/articulo/<?=$user_id?>/<?=$fila->Id?>" class="btn btn-default">Ir al artículo</a>
                </p>
            </div>
        </div>
	<?php
